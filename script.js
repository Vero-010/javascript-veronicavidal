...
let capital = 500000;
let aumento = 0.02;
let gananciafinal = capital * aumento;
console.log(gananciafinal);

//Ejercicio 3 ejercicios en javascript
let calificaciones_parciales = 0.55;
let examen_final = 0.30;
let trabajo_final = 0.15;
let nota_final = calificaciones_parciales + examen_final + trabajo_final;
console.log(nota_final);

//Ejercicio 4 ejercicios en javascript
let articulo = 3000;
let ganancia = 0.3;
let precio_final = articulo * ganancia;
